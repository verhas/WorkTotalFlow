 ...
 */
class SupplierTriuple<K, V, I, R, T, C> extends Triuple<Step<K, V, I, R, T, C>, ActionDef<K, V, I, R, T, C>, R> {

    private SupplierTriuple(Step<K, V, I, R, T, C> step, ActionDef<K, V, I, R, T, C> action, R name) {
        super(step, action, name);
    }

    static <K, V, I, R, T, C> SupplierTriuple<K, V, I, R, T, C> tuple(Step<K, V, I, R, T, C> step, ActionDef<K, V, I, R, T, C> action, R name) {
